...
#ifdef KISAK_VITA
// the display queue is three deep, so two skinned frames overwrite one still in flight
#define GFX_SKINNED_CACHE_FRAMES 3
#else
#define GFX_SKINNED_CACHE_FRAMES 2
#endif
    GfxVertexBufferState skinnedCacheVbPool[GFX_SKINNED_CACHE_FRAMES]; // ...
